...
public class WriteResponse implements org.apache.thrift.TBase<WriteResponse, WriteResponse._Fields>, java.io.Serializable, Cloneable, Comparable<WriteResponse> {
   ...
   * @see Status
   */
  public WriteResponse setStatus(@org.apache.thrift.annotation.Nullable Status status) {
    this.status = status;
    return this;
  }
  ...
  public WriteResponse setMsg(@org.apache.thrift.annotation.Nullable java.lang.String msg) {
    this.msg = msg;
    return this;
  }
